...
2. **Design a unified network** of efficient routes covering all schools.
3. **Share buses** among schools to cut redundant vehicles.
4. **Sync schedules** so buses run at optimal times.
