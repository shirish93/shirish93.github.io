---
author: shirish
beforetoc: Don't entomb your applications. Make them flexible, be ready to make gradual
  changes. That way, they won't need an overhaul from scratch when the time comes.
categories:
- engineering
- software
- rewrite
